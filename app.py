...
st.title('Track slot availability for corona pandemic vaccinations')
st.info('Sometimes you may not see an output! Please try after 5 Minutes ')
...
with right_column_1:
    numdays = st.slider('Select the no of days to check from current date', 0, 30, 7)

with left_column_1:
    dist_inp = st.selectbox('Select District',["Thane"] + unique_districts)
...
<div class="footer">
<p>Created by <a style='display: block; text-align: center;' href="www.linkedin.com/in/jaiprakash-prajapati" target="_blank">Jaiprakash Prajapati</a></p>
</div>
"""
st.markdown(footer,unsafe_allow_html=True)
# st.markdown("_- Jaiprakash Prajapati_")
